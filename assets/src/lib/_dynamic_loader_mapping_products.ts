...
/* generated from assets/node_modules/@carbon/ibm-products-web-components/custom-elements.json of ibm-products web-components v0.33.0 for Graphene.Internal.ProductCoreComponents */

type ComponentImports = { [componentName: string]: () => Promise<any> };

// Define a static mapping for component imports
export const productComponentImports: ComponentImports = {
  "c4p-about-modal": () =>
