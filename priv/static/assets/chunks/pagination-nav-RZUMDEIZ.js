...
<<<<<<<< HEAD:priv/static/assets/chunks/pagination-nav-H7OX3VKP.js
...
>>>>>>>> 8ec8e62f80de45f4d42992fbfd1d4576ecc905a2:priv/static/assets/chunks/pagination-nav-RZUMDEIZ.js
...
// node_modules/@carbon/web-components/es/components/pagination-nav/defs.js
var PAGINATION_NAV_SIZE;
(function(PAGINATION_NAV_SIZE2) {
  PAGINATION_NAV_SIZE2["SMALL"] = "sm";
  PAGINATION_NAV_SIZE2["MEDIUM"] = "md";
  PAGINATION_NAV_SIZE2["LARGE"] = "lg";
})(PAGINATION_NAV_SIZE || (PAGINATION_NAV_SIZE = {}));
var PAGINATION_TOOLTIP_ALIGNMENT;
(function(PAGINATION_TOOLTIP_ALIGNMENT2) {
  PAGINATION_TOOLTIP_ALIGNMENT2["START"] = "start";
  PAGINATION_TOOLTIP_ALIGNMENT2["CENTER"] = "center";
  PAGINATION_TOOLTIP_ALIGNMENT2["END"] = "end";
})(PAGINATION_TOOLTIP_ALIGNMENT || (PAGINATION_TOOLTIP_ALIGNMENT = {}));
var PAGINATION_TOOLTIP_POSITION;
(function(PAGINATION_TOOLTIP_POSITION2) {
  PAGINATION_TOOLTIP_POSITION2["TOP"] = "top";
  PAGINATION_TOOLTIP_POSITION2["RIGHT"] = "right";
  PAGINATION_TOOLTIP_POSITION2["BOTTOM"] = "bottom";
  PAGINATION_TOOLTIP_POSITION2["LEFT"] = "left";
})(PAGINATION_TOOLTIP_POSITION || (PAGINATION_TOOLTIP_POSITION = {}));

// node_modules/@carbon/web-components/es/components/pagination-nav/pagination-nav.js
var translationIds = {
...
var defaultTranslateWithId = (messageId) => {
  return defaultTranslations[messageId];
};
var CDSPaginationNav = class CDSPaginationNav2 extends i2 {
  constructor() {
    super(...arguments);
  ...
  _pageWouldBeHidden(page) {
    ...
    const wouldBeHiddenInBack = page >= this.totalItems - this.cuts.back - 1 && page <= this.totalItems - 2;
    ...
    if (count > 1) {
      return b`
        ...
        e2.target.value = "";
              ...
              ${Array.from({ length: count }).map((_, i3) => b`
                  <option
                    value="${fromIndex + i3}"
                    data-page="${fromIndex + i3 + 1}"
                    key="overflow-${fromIndex + i3}">
                    ${fromIndex + i3 + 1}
                  </option>
                `)}
            </select>
  ...
  render() {
    ...
    this.itemsDisplayedOnPage >= 5 || this.itemsDisplayedOnPage <= 4 && this.page <= 1 ? this._renderPaginationItem(0, this.page === 0) : ""}
          ${/* render first overflow */
    this._renderPaginationOverflow(startOffset, this.cuts.front)}
          ${// render items between overflows
    Array.from({ length: this.totalItems }).map((_, i3) => i3).slice(startOffset + this.cuts.front, (1 + this.cuts.back) * -1).map((item) => this._renderPaginationItem(item, this.page === item))}
    ...
    this.totalItems > 1 ? this._renderPaginationItem(this.totalItems - 1, this.page === this.totalItems - 1) : ""}
          <li class="${prefix}--pagination-nav__list-item">
            <cds-icon-button
              kind="ghost"
              align="${align}"
  ...
  updated(changedProperties) {
    ...
    if (changedProperties.has("totalItems") || changedProperties.has("itemsShown") || changedProperties.has("size")) {
      let numberOfPages;
      switch (this.size) {
