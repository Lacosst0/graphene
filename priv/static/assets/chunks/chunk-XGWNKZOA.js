...
var N = (t3, i5) => {
  ...
  for (let i6 = 0; i6 < s4; i6++) {
    ...
    for (; f3 < s5.length && (c4.lastIndex = f3, u3 = c4.exec(s5), null !== u3); )
      f3 = c4.lastIndex, c4 === v ? "!--" === u3[1] ? c4 = _ : void 0 !== u3[1] ? c4 = m : void 0 !== u3[2] ? (y.test(u3[2]) && (n4 = RegExp("</" + u3[2], "g")), c4 = p) : void 0 !== u3[3] && (c4 = p) : c4 === p ? ">" === u3[0] ? (c4 = n4 ?? v, d3 = -1) : void 0 === u3[1] ? d3 = -2 : (d3 = c4.lastIndex - u3[2].length, a3 = u3[1], c4 = void 0 === u3[3] ? p : '"' === u3[3] ? $ : g) : c4 === $ || c4 === g ? c4 = p : c4 === _ || c4 === m ? c4 = v : (c4 = p, n4 = void 0);
  ...
  _$AI(t3, i5 = this, s4, e4) {
    ...
    if (void 0 === h3)
      ...
      for (t3 = h3[0], n4 = 0; n4 < h3.length - 1; n4++)
        r4 = M(this, e5[s4 + n4], i5, n4), r4 === E && (r4 = this._$AH[n4]), o5 || (o5 = !a(r4) || r4 !== this._$AH[n4]), r4 === A ? t3 = A : t3 !== A && (t3 += (r4 ?? "") + h3[n4 + 1]), this._$AH[n4] = r4;
    }
    o5 && !e4 && this.j(t3);
  }
  j(t3) {
...
B?.(S, k), (t.litHtmlVersions ?? (t.litHtmlVersions = [])).push("3.3.2");
var D = (t3, i5, s4) => {
...
var y2 = class extends HTMLElement {
  ...
  requestUpdate(t3, s4, i5, e4 = false, h3) {
    if (void 0 !== t3) {
      ...
      if (false === e4 && (h3 = this[t3]), i5 ?? (i5 = r4.getPropertyOptions(t3)), !((i5.hasChanged ?? f2)(h3, s4) || i5.useDefault && i5.reflect && h3 === this._$Ej?.get(t3) && !this.hasAttribute(r4._$Eu(t3, i5))))
        return;
      this.C(t3, s4, i5);
    }
