...
// node_modules/@carbon/web-components/es/components/search/search.scss.js
...
// node_modules/@carbon/web-components/es/components/search/search.js
var CDSSearch = class CDSSearch2 extends HostListenerMixin(FocusMixin(FormMixin(i2))) {
  constructor() {
    super(...arguments);
  ...
  _handleExpand(e2) {
    ...
    const isMagnifierClick = path.some((n2) => {
      var _a;
      return (_a = n2 === null || n2 === void 0 ? void 0 : n2.classList) === null || _a === void 0 ? void 0 : _a.contains(`${prefix}--search-magnifier`);
    });
    ...
    return b`
      <div class="${prefix}--search-magnifier">
        <slot name="icon" @slotchange=${handleSlotChange}>
          ${hasCustomIcon ? b`` : iconLoader(_162, {
      part: "search-icon",
...
CDSSearch.shadowRootOptions = Object.assign(Object.assign({}, i2.shadowRootOptions), { delegatesFocus: true });
...
__decorate([
  n({ attribute: "autocomplete" })
], CDSSearch.prototype, "autoComplete", void 0);
__decorate([
  n({ attribute: "close-button-label-text" })
