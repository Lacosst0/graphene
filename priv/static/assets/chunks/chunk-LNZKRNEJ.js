...
var MODAL_SIZE;
(function(MODAL_SIZE2) {
  MODAL_SIZE2["EXTRA_SMALL"] = "xs";
  MODAL_SIZE2["SMALL"] = "sm";
  MODAL_SIZE2["MEDIUM"] = "md";
  MODAL_SIZE2["LARGE"] = "lg";
})(MODAL_SIZE || (MODAL_SIZE = {}));

// node_modules/@carbon/web-components/es/components/modal/modal.scss.js
...
// node_modules/@carbon/web-components/es/components/modal/modal.js
var CDSModal = class CDSModal2 extends HostListenerMixin(i2) {
  constructor() {
    super(...arguments);
    this._launcher = null;
    ...
    this._handleHostKeydown = (event) => {
      ...
      if (this.open && this.shouldSubmitOnEnter && event.key === "Enter" && target && document.activeElement !== primaryButton) {
        ...
        const targetIsCloseButton = !!target.closest(closeButton) || !!((_b = (_a = document.activeElement) === null || _a === void 0 ? void 0 : _a.closest) === null || _b === void 0 ? void 0 : _b.call(_a, closeButton));
      ...
      if (event.key === "Tab") {
        ...
        if (event.shiftKey && (((_c = this.shadowRoot) === null || _c === void 0 ? void 0 : _c.activeElement) === _firstElement || document.activeElement === _firstElement)) {
  ...
  _getFooterElements() {
    ...
    const primaryButton = this.querySelector(`${prefix}-modal-footer-button[kind="primary"]`) || this.querySelector(`${prefix}-modal-footer-button[kind="danger"]`) || null;
    ...
    if (this.WORKING_LOADING_STATUSES.includes(this.loadingStatus)) {
      ...
      if (secondaryButtons[0]) {
        if (!footer.hasAttribute("has-three-buttons")) {
          ...
          secondaryButtons.forEach((b2) => b2.removeAttribute("disabled"));
        }
      }
  ...
  render() {
    ...
    const containerClass = this.containerClass.split(" ").filter(Boolean).reduce((acc, item) => Object.assign(Object.assign({}, acc), { [item]: true }), {});
    const containerClasses = e(Object.assign({ [`${prefix}--modal-container`]: true, [`${prefix}--modal-container--${size}`]: size }, containerClass));
    return b`
      <div
        ...
        ${hasScrollingContent ? b` <div class="cds--modal-content--overflow-indicator"></div> ` : ``}
      </div>
    `;
  }
...
__decorate([
  n({ reflect: true, attribute: "loading-status" })
], CDSModal.prototype, "loadingStatus", void 0);
__decorate([
  n({ type: String, attribute: "loading-description" })
], CDSModal.prototype, "loadingDescription", void 0);
__decorate([
  n({ type: Number, attribute: "loading-success-delay" })
], CDSModal.prototype, "loadingSuccessDelay", void 0);
__decorate([
  n({ type: String, attribute: "loading-icon-description" })
...
__decorate([
  n({ type: Boolean, attribute: "prevent-close" })
], CDSModal.prototype, "preventClose", void 0);
CDSModal = __decorate([
  carbonElement(`${prefix}-modal`)
], CDSModal);

// node_modules/@carbon/web-components/es/components/modal/modal-body.js
var CDSModalBody = class CDSModalBody2 extends i2 {
  constructor() {
    super(...arguments);
  ...
  render() {
    return b` <slot @slotchange=${this.checkScroll}></slot> `;
  }
};
...
// node_modules/@carbon/web-components/es/components/modal/modal-body-content.js
var CDSModalBodyContent = class CDSModalBodyContent2 extends i2 {
  render() {
    return b`<slot></slot>`;
  }
};
...
// node_modules/@carbon/web-components/es/components/modal/modal-close-button.js
var CDSModalCloseButton = class CDSModalCloseButton2 extends FocusMixin(i2) {
  constructor() {
    super(...arguments);
...
CDSModalCloseButton.shadowRootOptions = Object.assign(Object.assign({}, i2.shadowRootOptions), { delegatesFocus: true });
CDSModalCloseButton.styles = styles;
__decorate([
...
// node_modules/@carbon/web-components/es/components/modal/modal-footer.js
var CDSModalFooter = class CDSModalFooter2 extends i2 {
  constructor() {
    super(...arguments);
...
__decorate([
  n({ type: Boolean, reflect: true, attribute: "has-three-buttons" })
...
// node_modules/@carbon/web-components/es/components/modal/modal-footer-button.js
var CDSModalFooterButton = class CDSModalFooterButton2 extends CDSButton$1 {
};
...
// node_modules/@carbon/web-components/es/components/modal/modal-header.js
var CDSModalHeader = class CDSModalHeader2 extends i2 {
  constructor() {
    super(...arguments);
...
CDSModalHeader.styles = styles;
CDSModalHeader = __decorate([
  carbonElement(`${prefix}-modal-header`)
], CDSModalHeader);

// node_modules/@carbon/web-components/es/components/modal/modal-heading.js
var CDSModalHeading = class CDSModalHeading2 extends i2 {
  render() {
    return b` <slot></slot> `;
  }
};
...
// node_modules/@carbon/web-components/es/components/modal/modal-label.js
var CDSModalLabel = class CDSModalLabel2 extends i2 {
  render() {
    return b` <slot></slot> `;
  }
};
