...
// node_modules/@carbon/icons/es/arrow--up/16.js
var _16 = {
  "elem": "svg",
  "attrs": {
...
// node_modules/@carbon/icons/es/arrow--up/20.js
var _20 = {
  "elem": "svg",
  "attrs": {
    "xmlns": "http://www.w3.org/2000/svg",
...
// node_modules/@carbon/icons/es/arrow--up/24.js
var _24 = {
  "elem": "svg",
  "attrs": {
    "xmlns": "http://www.w3.org/2000/svg",
...
// node_modules/@carbon/ibm-products-web-components/es/components/big-number/constants.js
var BigNumberSize;
(function(BigNumberSize2) {
  BigNumberSize2["Default"] = "default";
  BigNumberSize2["Large"] = "lg";
  BigNumberSize2["XLarge"] = "xl";
})(BigNumberSize || (BigNumberSize = {}));
var Characters;
(function(Characters2) {
  Characters2["Dash"] = "\u2013";
  Characters2["Slash"] = "/";
  Characters2["Percentage"] = "%";
})(Characters || (Characters = {}));
var DefaultLocale = "en-US";
var UNKNOWN = "Unknown";

// node_modules/@carbon/ibm-products-web-components/es/components/big-number/big-number-skeleton.scss.js
...
// node_modules/@carbon/ibm-products-web-components/es/components/big-number/big-number-skeleton.js
var blockClass = `${prefix}--big-number-skeleton`;
var CDSBigNumberSkeleton = class CDSBigNumberSkeleton2 extends i2 {
  constructor() {
    super(...arguments);
  ...
  render() {
    const { size } = this;
    const bigNumberSkeletonClasses = e({
      [`${blockClass}`]: true,
...
// node_modules/@carbon/ibm-products-web-components/es/components/big-number/big-number.scss.js
...
// node_modules/@carbon/ibm-products-web-components/es/components/big-number/big-number.js
var blockClass2 = `${prefix}--big-number`;
var CDSBigNumber = class CDSBigNumber2 extends i2 {
  constructor() {
    super(...arguments);
  ...
  _shouldDisplayDenominator(truncatedValue, truncatedTotal) {
    return !this.percentage && !!this.total && !!this.value && this.total > this.value && truncatedValue !== truncatedTotal;
  }
  _getTrendingIcon() {
    switch (this.size) {
  ...
  render() {
    ...
    const bigNumberClasses = e({
      [`${blockClass2}`]: true,
      [`${blockClass2}--lg`]: size === "lg",
      [`${blockClass2}--xl`]: size === "xl"
    });
    ...
    return b`
      <div class=${bigNumberClasses}>
        <!-- Label and tooltip  -->
        <span class="${blockClass2}__row">
          <slot name="label">
            <h4 class="${blockClass2}__label">${label}</h4>
          </slot>
        </span>
        <span class="${blockClass2}__row" role="math">
          <!-- Trending up arrow  -->
          ${trending ? b`<slot name="trending-icon"
                >${iconLoader(this._getTrendingIcon(), {
      slot: "icon",
      class: `${blockClass2}__trend`
    })}
              </slot>` : A}

          <!-- Numerator  -->
          <span class="${blockClass2}__value">
            ${percentage ? b`<div class="${blockClass2}__percentage">
                  ${truncatedValue}<span class="${blockClass2}__percentage-mark"
          ...
          <!-- Denominator -->
          ${shouldDisplayDenominator ? b`<span class="${blockClass2}__total">
                <span>${`${Characters.Slash}${truncatedTotal}`}</span>
              </span>` : A}

          <!-- Icon button -->
          <span class="${blockClass2}__icon-button">
...
CDSBigNumber.styles = styles2;
__decorate([
  n({ type: Number, attribute: "fraction-digits" })
...
@carbon/ibm-products-web-components/es/components/big-number/big-number.js:
  (**
   * @license
   *
