import {
  ne
} from "./chunk-G7S2CLZN.js";
import {
  e as e4,
  f,
  r as r2
} from "./chunk-RL7HWT74.js";
import {
  carbonPrefix,
  prefix as prefix2
...
var n2 = e2(class extends f {
  ...
  update(i3, [s]) {
    const e6 = s !== this.G;
    return e6 && void 0 !== this.G && this.rt(void 0), (e6 || this.lt !== this.ct) && (this.G = s, this.ht = i3.options?.host, this.rt(this.ct = i3.element)), A;
  }
  rt(t) {
