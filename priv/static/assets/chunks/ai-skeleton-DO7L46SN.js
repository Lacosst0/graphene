...
// node_modules/@carbon/web-components/es/components/ai-skeleton/ai-skeleton-icon.js
var CDSAISkeletonIcon = class CDSAISkeletonIcon2 extends i2 {
  constructor() {
    super(...arguments);
    this.customStyles = "";
  }
  render() {
    return b`<cds-skeleton-icon
...
__decorate([
  n({ attribute: "custom-styles" })
], CDSAISkeletonIcon.prototype, "customStyles", void 0);
CDSAISkeletonIcon = __decorate([
  carbonElement(`${prefix}-ai-skeleton-icon`)
], CDSAISkeletonIcon);

// node_modules/@carbon/web-components/es/components/ai-skeleton/ai-skeleton-placeholder.js
var CDSAISkeletonPlaceholder = class CDSAISkeletonPlaceholder2 extends i2 {
  render() {
    return b`<cds-skeleton-placeholder
...
// node_modules/@carbon/web-components/es/components/ai-skeleton/ai-skeleton-text.js
var CDSAISkeletonText = class CDSAISkeletonText2 extends i2 {
  constructor() {
    super(...arguments);
    this.heading = false;
    this.width = "100%";
