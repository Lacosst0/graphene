...
var CDSChecklistGroup = class CDSChecklistGroup2 extends i2 {
  ...
  render() {
    const { title } = this;
    return b`
      ${title && b`<h3 title=${title} class="${prefix}--checklist__list-title">
        ${title}
      </h3>`}
...
// node_modules/@carbon/ibm-products-web-components/es/components/checklist/checklist.types.js
var Kinds;
(function(Kinds2) {
  Kinds2["unchecked"] = "unchecked";
  Kinds2["indeterminate"] = "indeterminate";
  Kinds2["checked"] = "checked";
  Kinds2["disabled"] = "disabled";
  Kinds2["error"] = "error";
})(Kinds || (Kinds = {}));
var Statuses;
(function(Statuses2) {
  Statuses2["NotStarted"] = "not started";
  Statuses2["InProgress"] = "in progress";
  Statuses2["Completed"] = "completed";
  Statuses2["Error"] = "error";
  Statuses2["Disabled"] = "disabled";
})(Statuses || (Statuses = {}));

// node_modules/@carbon/ibm-products-web-components/es/components/checklist/checklist-item.js
var CDSChecklistItem = class CDSChecklistItem2 extends i2 {
  constructor() {
    super(...arguments);
...
// node_modules/@carbon/ibm-products-web-components/es/components/checklist/checklist-chart.js
var blockClass = `${prefix}--checklist__chart`;
...
var CDSChecklistChart = class CDSChecklistChart2 extends i2 {
  constructor() {
    super(...arguments);
    this.value = 0;
  }
...
// node_modules/@carbon/ibm-products-web-components/es/components/checklist/checklist-icon.js
var blockClass2 = `${prefix}--checklist__icon`;
var CDSChecklistIcon = class CDSChecklistIcon2 extends i2 {
  constructor() {
    super(...arguments);
    this.kind = Kinds.unchecked;
  }
  render() {
    const icon = this.kind === Kinds.checked ? _16 : this.kind === Kinds.indeterminate ? _162 : this.kind === Kinds.error ? _164 : _163;
    const classes = e({
      [`${blockClass2}`]: true,
      [`${blockClass2}--${this.kind}`]: true
    });
    return b` <span class="${classes}">
...
// node_modules/@carbon/ibm-products-web-components/es/components/checklist/checklist.js
var blockClass3 = `${prefix}--checklist`;
var CDSChecklist = class CDSChecklist2 extends i2 {
  constructor() {
    super(...arguments);
    this.open = false;
  ...
  render() {
    ...
    const classes = e({
      [`${blockClass3}`]: true,
      [`${blockClass3}__closed`]: !open
    });
    return b`
      <aside class=${classes} aria-label="Checklist">
        <!-- Header -->
        <header class="${blockClass3}__header">
          <slot name="checklist-header">
            <slot name="header-chart">
              <c4p-checklist-chart value=${chartValue}></c4p-checklist-chart>
            </slot>
            <div class="${blockClass3}__titles">
              <!-- checklist title -->
              <slot name="header-title">
                ${title && b`<h2 class="${blockClass3}__title">${title}</h2>`}
              </slot>
              <!-- chart label -->
              <slot name="header-chartLabel">
                ${chartLabel && b`<p class="${blockClass3}__chart-label">${chartLabel}</p>`}
              </slot>
            </div>
          </slot>
          <!-- Checklist toggle button -->
          ${!disableToggle && b`<cds-icon-button
            kind="ghost"
            size="sm"
            align=${toggleLabelAlign}
            aria-label=${toggleAriaLabel}
            class="${blockClass3}__toggle"
            @click=${onToggle}
          >
            ${iconLoader(_165, {
      slot: "icon",
      class: `${blockClass3}__chevron`
    })}
            <span slot="tooltip-content">${toggleLabel}</span>
          </cds-icon-button>`}
        </header>
        <div class="${blockClass3}__content-outer">
          <div class="${blockClass3}__content-inner">
            <!-- Checklist body -->
            <!-- This is where you add c4p-checklist-group elements-->
            <slot></slot>

            <!-- Checklist footer -->
            <div class="${blockClass3}__footer">
              <slot name="checklist-footer">
                ${viewAllLabel && b`<cds-link
                  role="link"
                  @click=${viewAll}
...
__decorate([
  n({ type: String, attribute: "chart-label" })
], CDSChecklist.prototype, "chartLabel", void 0);
__decorate([
  n({ type: Number, attribute: "chart-value" })
], CDSChecklist.prototype, "chartValue", void 0);
__decorate([
  n({ type: Boolean, attribute: "disable-toggle" })
], CDSChecklist.prototype, "disableToggle", void 0);
__decorate([
  n({ type: String, attribute: "toggle-label" })
], CDSChecklist.prototype, "toggleLabel", void 0);
__decorate([
  n({ type: String, attribute: "toggle-label-align" })
], CDSChecklist.prototype, "toggleLabelAlign", void 0);
__decorate([
  n({ type: String, attribute: "toggle-aria-label" })
], CDSChecklist.prototype, "toggleAriaLabel", void 0);
__decorate([
  n({ type: String, attribute: "view-all-label" })
...
@carbon/ibm-products-web-components/es/components/checklist/checklist-group.js:
  (**
   * @license
   *
...
@carbon/ibm-products-web-components/es/components/checklist/checklist-item.js:
  (**
   * @license
   *
   * Copyright IBM Corp. 2025
...
@carbon/ibm-products-web-components/es/components/checklist/checklist-chart.js:
  (**
   * @license
   *
   * Copyright IBM Corp. 2025
...
@carbon/ibm-products-web-components/es/components/checklist/checklist-icon.js:
  (**
   * @license
   *
   * Copyright IBM Corp. 2025
...
@carbon/ibm-products-web-components/es/components/checklist/checklist.js:
  (**
   * @license
   *
   * Copyright IBM Corp. 2025
