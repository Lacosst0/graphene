<<<<<<<< HEAD:priv/static/assets/chunks/tag-RBAJ3SDY.js
...
>>>>>>>> 8ec8e62f80de45f4d42992fbfd1d4576ecc905a2:priv/static/assets/chunks/tag-APKQYZAW.js
...
// node_modules/@carbon/web-components/es/components/tag/defs.js
var TAG_SIZE;
(function(TAG_SIZE2) {
  TAG_SIZE2["LARGE"] = "lg";
  TAG_SIZE2["MEDIUM"] = "md";
...
var CDSTag = class CDSTag2 extends HostListenerMixin(FocusMixin(i2)) {
  ...
  updated() {
    ...
    if (root instanceof ShadowRoot) {
      ...
      if (parent === `${prefix}-selectable-tag` || parent === `${prefix}-operational-tag`) {
  ...
  render() {
    ...
    return b`
      ${size !== TAG_SIZE.SMALL ? b`<slot name="icon" @slotchange="${handleIconSlotChange}"></slot>` : ""}
      ...
      ${filter ? b`
            <button class="${prefix}--tag__close-icon" ?disabled=${disabled}>
              ${iconLoader(_16, { "aria-label": title })}
            </button>
          ` : ``}
    `;
  }
...
__decorate([
  n({ type: Boolean, attribute: "has-custom-icon", reflect: true })
...
// node_modules/@carbon/web-components/es/components/tag/dismissible-tag.js
var CDSDismissibleTag = class CDSDismissibleTag2 extends HostListenerMixin(FocusMixin(CDSTag$1)) {
  constructor() {
    super(...arguments);
    this._handleClick = (event) => {
      if (event.composedPath().indexOf(this._buttonNode) >= 0) {
        if (this.disabled) {
          ...
          if (this.dispatchEvent(new CustomEvent(this.constructor.eventBeforeClose, init))) {
            this.open = false;
            if (nextFocusableTag) {
              const nextCloseIcon = nextFocusableTag._buttonNode;
              if (nextCloseIcon) {
                nextCloseIcon.focus();
              }
            }
  ...
  _findNextFocusableTag() {
    ...
    while (nextElement) {
      if (nextElement.tagName.toLowerCase() === `${prefix}-dismissible-tag` && !nextElement.hasAttribute("disabled") && nextElement.getAttribute("open") !== "false") {
        return nextElement;
      }
   ...
   */
  _handleAILabelSlotChange({ target }) {
    const hasContent = target.assignedNodes().filter((elem) => elem.matches !== void 0 ? (
      // remove reference of slug in v12
      elem.matches(this.constructor.aiLabelItem) || // remove reference of slug in v12
...
__decorate([
  n({ type: String, attribute: "dismiss-tooltip-label", reflect: true })
...
__decorate([
  n({ type: String, attribute: "tag-title", reflect: true })
...
// node_modules/@carbon/web-components/es/components/tag/tag-skeleton.js
var CDSTagSkeleton = class CDSTagSkeleton2 extends i2 {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    return b` <span class="${tagClasses}"></span> `;
  }
};
...
// node_modules/@carbon/web-components/es/components/tag/selectable-tag.js
var CDSSelectableTag = class CDSSelectableTag2 extends HostListenerMixin(FocusMixin(i2)) {
  constructor() {
    super(...arguments);
  ...
  render() {
    ...
    return b` ${hasEllipsisApplied ? b` <cds-tooltip align="bottom" keyboard-only leave-delay-ms=${0}>
          <cds-tag
...
// node_modules/@carbon/web-components/es/components/tag/operational-tag.js
var CDSOperationalTag = class CDSOperationalTag2 extends HostListenerMixin(FocusMixin(i2)) {
  constructor() {
    super(...arguments);
    this.triggerEvents = (event) => {
      if (this.disabled) {
  ...
  render() {
    ...
    return b` ${hasEllipsisApplied ? b` <cds-tooltip
          align="bottom"
          keyboard-only
          closeOnActivation
          leave-delay-ms=${0}>
